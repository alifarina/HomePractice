...
public class Comment {
    ...
    @SerializedName("bitecommentid")
    @Expose
    private String bitecommentid;
    ...
    /**
     * @return The bitecommentid
     */
    public String getBitecommentid() {
        return bitecommentid;
    }

    /**
     * @param bitecommentid The bitecommentid
     */
    public void setBitecommentid(String bitecommentid) {
        this.bitecommentid = bitecommentid;
    }
